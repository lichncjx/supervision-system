...
async function createPreviewWorks(departments, users) {
  ...
  const commonPriority = {
    ...
    departmentIds: [planDept.id],
    cooperateDepartmentIds: [techDept.id],
    creatorId: managerA.id,
    proposedLeaderId: vpA.id,
    approvalLeaderId: vpA.id,
    deptLeaderId: leaderA.id,
    deptManagerId: managerA.id,
    responsibleLeader: leaderA.name,
    supervisor: managerA.name,
    deptLeaderName: leaderA.name,
    deptManagerName: managerA.name,
  ...
  const commonTodo = {
    ...
    departmentIds: [planDept.id, techDept.id],
    cooperateDepartmentIds: [qualityDept.id],
  ...
  const works = [
    ...
    },
    {
      ...
      departmentIds: [techDept.id],
      cooperateDepartmentIds: [planDept.id],
      responsiblePersons: ['赵六'],
      cooperatePersons: ['钱七'],
