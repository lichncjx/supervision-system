  ...
  return [
    {
      ...
      data: {
        ...
        supervisor: '事项实际责任人A',
        deptLeaderId: user.deptLeaderA.id,
        deptManagerId: user.deptManagerA1.id,
        deptLeaderName: user.deptLeaderA.name,
        deptManagerName: user.deptManagerA1.name,
    ...
    },
    {
      ...
      data: {
        ...
        supervisor: '事项实际责任人A2',
        deptLeaderId: user.deptLeaderA.id,
        deptManagerId: user.deptManagerA2.id,
        deptLeaderName: user.deptLeaderA.name,
        deptManagerName: user.deptManagerA2.name,
        completeTime: farFuture,
      },
    },
    {
